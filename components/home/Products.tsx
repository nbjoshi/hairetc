                ...
                <div className="flex flex-1 flex-col px-5 py-5 sm:px-6 sm:py-6">
                  ...
                  <div className="mt-3 flex flex-wrap gap-1.5">
                    {product.chips.map((chip) => (
                      <span
                        key={chip}
                        className="inline-flex rounded-full border border-black/[0.08] bg-white/[0.12] px-2.5 py-0.5 text-[10px] font-medium tracking-wide text-(--color-secondary)/70 uppercase sm:px-3 sm:py-1 sm:text-xs"
                      >
                        {chip}
                      </span>
                    ))}
